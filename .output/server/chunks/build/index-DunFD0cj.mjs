import { _ as __nuxt_component_0$1 } from './nuxt-link-De2Madnv.mjs';
import { defineComponent, mergeProps, ref, unref, withCtx, createTextVNode, openBlock, createBlock, createVNode, reactive, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderStyle, ssrIncludeBooleanAttr, ssrRenderClass } from 'vue/server-renderer';
    ...
    const experience = [
      {
        ...
        company: "Termii Inc. \xB7 Lagos, Nigeria (Hybrid)",
      ...
      },
      {
        ...
        company: "Nash Renewables \xB7 Hamburg, Germany (Remote, Contract)",
...
//# sourceMappingURL=index-DunFD0cj.mjs.map
